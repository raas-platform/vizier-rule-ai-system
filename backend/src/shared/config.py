...
class Settings(BaseSettings):
    ...
    analysis_default_model: str = Field(default="gpt-3.5-turbo", alias="ANALYSIS_DEFAULT_MODEL")
    analysis_fallback_model: str = Field(default="gpt-4o", alias="ANALYSIS_FALLBACK_MODEL")
